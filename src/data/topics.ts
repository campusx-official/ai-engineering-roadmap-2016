...
export const topics: Record<string, TopicSet> = {
  ...
  'M11.1': { sig: '14f3719f', labels: [
    ...
    'What carries over from text LLMs',
  ...
  'M11.4': { sig: '8c1a44ba', labels: [
    ...
    'Tables, forms & merged cells',
    'How models read charts',
    'Schema before prompt',
    'Extract & validate fields',
    'Grounding fields to page regions',
    'Document failure modes',
    'Routing low confidence to review',
    'Pages & regions as retrieval units',
    'Hybrid text + visual retrieval',
    'Citing the page you answered from',
  ...
  'M11.7': { sig: 'f766b031', labels: [
    ...
    'What Kokoro turns text into',
    'Voice choice & prosody',
  ...
  'M11.8': { sig: '3ff5c7d2', labels: [
    ...
    'Why endpointing is hard',
    'Barge-in & interruption',
    'Acting on partial transcripts',
    'State after a cut-short turn',
    'Silence, dead air & dropped calls',
    'Noise, crosstalk & bad mics',
    'Staying alive during tool calls',
  ...
  'M11.9': { sig: '8d137ee8', labels: [
    ...
    'Cross-modal vs caption-then-search',
  ...
  'M11.11': { sig: 'c4b97e40', labels: [
    ...
    'Claims attached to sources',
    'Notes and interim summaries',
